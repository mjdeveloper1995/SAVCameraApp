...
public class USBCameraActivityImage extends AppCompatActivity implements CameraDialog.CameraDialogParent, CameraViewInterface.Callback {
    ...
    private void initView() {
        ...
        capture_button1.setVisibility(View.VISIBLE);
...
//                            Toast.makeText(USBCameraActivityImage.this, "videoPath = " + videoPath, Toast.LENGTH_SHORT).show();
                        }
                    });
...
//                    Toast.makeText(USBCameraActivity.this, "videoPath = " + videoPath, Toast.LENGTH_SHORT).show();
    ...
    private void showResolutionListDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(USBCameraActivityImage.this);
        View rootView = LayoutInflater.from(USBCameraActivityImage.this).inflate(R.layout.layout_dialog_list, null);
        ListView listView = (ListView) rootView.findViewById(R.id.listview_dialog);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(USBCameraActivityImage.this, android.R.layout.simple_list_item_1, getResolutionList());
        if (adapter != null) {
